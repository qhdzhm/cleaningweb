      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-slate-400">
              <li>
                <a href="tel:0400000000" className="hover:text-teal-400 transition-colors flex items-center gap-2">
              ...
              <li>
                <a href="mailto:hello@naturepure.com.au" className="hover:text-teal-400 transition-colors flex items-center gap-2">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                  hello@naturepure.com.au
                </a>
              </li>
