    ...
    try {
      const response = await fetch("https://api.web3forms.com/submit", {
        ...
        body: JSON.stringify({
          ...
          subject: `New Quote Request from ${formData.name} - Est. $${minPrice}-$${maxPrice}`,
            ...
            <form onSubmit={handleSubmit} className="bg-white rounded-2xl p-6 md:p-8 shadow-lg border border-slate-100">
              {submitStatus === "success" ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-slate-600 mb-4">We&apos;ve received your quote request for <strong>${minPrice}-${maxPrice}</strong> and will get back to you soon.</p>
                  <button
                    type="button"
                ...
                <>
                  {/* Home Details - Interactive */}
                  <div className="mb-6">
                    <h3 className="font-semibold text-slate-800 mb-4">1. Tell us about your home</h3>
                  ...
                  <div className="mb-6 pt-6 border-t border-slate-100">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        placeholder="Pets, special requests, preferred day..."
                      />
                    </div>
                  </div>
                  ...
                  >
                    {isSubmitting ? (
                      ...
                      <>
                        Get My Quote (${minPrice}-${maxPrice})
                  ...
                  <p className="text-xs text-slate-500 text-center mt-4">
                    We&apos;ll confirm your quote within a few hours. No spam, ever.
                  </p>
                </>
              )}
            </form>
